...
/*
* Converted to Grained.ts
* Author : https://github.com/dasaniket20002
*/
export function grained(ele: string, opt: any) {
    ...
    function addCSSRule(sheet: any, selector: any, rules: any, index?: any) {
        var ins = '';
        if (selector.length) {
            ins = selector + "{" + rules + "}";
        } else {
